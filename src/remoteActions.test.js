...
describe('Remote interactions', () => {
  ...
  it('archives the remote Keys', async () => {
    const mockedDate = new Date(
        'Wed Sep 23 2020 00:00:00 GMT+0000 (Greenwich Mean Time)'
    );
    global.Date = jest.fn(() => mockedDate);
    const keyValue = {
      baseline:
          'chrome/default/archive/Wed Sep 23 2020 00:00:00 GMT+0000 (Greenwich Mean Time)/baseline/mock/resolved/path/file1'
    };
